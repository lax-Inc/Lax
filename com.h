/* com.h */
    ...
    _OP_DEF(opexe_0, "input",                          0,  1,       TST_STRING,                      OP_INPUT            )
...
#endif
    _OP_DEF(opexe_0, 0,                                0,  0,       0,                               OP_DOMICRO          )
    _OP_DEF(opexe_0, 0,                                0,  0,       0,                               OP_AST           )
    _OP_DEF(opexe_0, 0,                                0,  0,       0,                               OP_AST1          )
    ...
    _OP_DEF(opexe_2, "tarry",                          1,  1,       TST_NUMBER,                      OP_TARRY            )
    ...
    _OP_DEF(opexe_2, "head",                           1,  1,       TST_PAIR,                        OP_HEAD             )
    _OP_DEF(opexe_2, "tail",                           1,  1,       TST_PAIR,                        OP_TAIL              )
    _OP_DEF(opexe_2, "cons",                           2,  2,       TST_NONE,                        OP_CONS             )
    _OP_DEF(opexe_2, "set-head!",                      2,  2,       TST_PAIR TST_ANY,                OP_SETHEAD          )
    _OP_DEF(opexe_2, "set-tail!",                      2,  2,       TST_PAIR TST_ANY,                OP_SETTAIL          )
    ...
    _OP_DEF(opexe_2, "string->sign",                   1,  1,       TST_STRING,                      OP_STR2SIGN          )
    ...
    _OP_DEF(opexe_3, "sign?",                          1,  1,       TST_ANY,                         OP_SIGNP          )
    ...
    _OP_DEF(opexe_4, "image",                          1,  2,       TST_ANY TST_OUTPORT,             OP_IMAGE            )
    _OP_DEF(opexe_4, "nl",                             0,  1,       TST_OUTPORT,                     OP_NEWLINE          )
    _OP_DEF(opexe_4, "err",                            1,  INF_ARG, TST_NONE,                        OP_ERR0             )
    ...
    _OP_DEF(opexe_6, "micro?",                         1,  1,       TST_NONE,                        OP_MICROP           )
#undef _OP_DEF
